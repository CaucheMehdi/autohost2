...
public class WebAppCustomerController {
    ...
    private static final String URL_CUSTOMER_CREATE = "http://localhost:8889/customer/create";
    private static final String URL_CUSTOMER_DELETE = "http://localhost:8889/customer/delete";
    ...
    public String formSubmitCreateCustomer(@ModelAttribute FormNewCustomerDTO form, Model model) throws ClientProtocolException, IOException {
        ...
        String response = restRequest(form, URL_CUSTOMER_CREATE);
    ...
    public String formSubmitDeleteCustomer(@ModelAttribute FormDeleteCustomerDTO form, Model model) throws ClientProtocolException, IOException {
        logger.info("STARTING PROCESSING FORM");
        String response = restRequest(form, URL_CUSTOMER_DELETE);
    ...
    private Model addAttributeToView(Model model, String message) throws ClientProtocolException, IOException {
        ...
        model.addAttribute("form", new FormNewCustomerDTO());
        model.addAttribute("formDelete", new FormDeleteCustomerDTO());
     ...
     */
    private String restRequest(@ModelAttribute FormDTO form, String url) throws JsonProcessingException {
